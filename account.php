...
<div class="bg"><nav class="navbar navbar-default title1">
...
if (@$_GET['q'] == 1) {
    ...
    $result = mysqli_query($con, "SELECT * FROM quiz WHERE status = 'enabled' AND practice_op='0' ORDER BY date DESC") or die('Error');
    echo '<div> <div class="table-responsive">       <table class="table table-striped title1"  style="vertical-align:middle">
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Correct Answer</b></td><td style="vertical-align:middle"><b>Wrong Answer</b></td><td style="vertical-align:middle"><b>Total Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
...
$c = 1;
  ...
  <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></span></a></b></td></tr>';
    ...
    $c = 0;
    echo '</table></div></div>';
    $empty_result = mysqli_query($con, "SELECT * FROM quiz WHERE practice_op='0'") or die('Error');
    $empty_rowcount = mysqli_num_rows($empty_result);
    $empty_con_result = mysqli_query($con, "SELECT * FROM quiz WHERE practice_op='0' AND status = 'disabled' ") or die('Error');
    $empty_con_rowcount = mysqli_num_rows($empty_con_result);
    if($empty_rowcount == $empty_con_rowcount)
    {
        echo '<h4 class=" text-center"> No Upcoming Quiz Event Challenge. Till Then you can Practice </h4>';
            
    }  
    
    echo'<div class="panel" style="padding-top:1px;padding-left:8%;padding-right:8%;word-wrap:break-word"><h3 align="center" style="font-family:calibri">:: General Instructions ::</h3><br /><ul type="circle"><font style="font-size:14px;font-family:calibri">';
...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
     ...
     $eid   = @$_GET['eid'];
            ...
            echo '<div class="panel" style="margin-right:1%;margin-left:1%;margin-top:10px;border-radius:10px">';
            while ($row = mysqli_fetch_array($q)) {
...
<br />';
        ...
        $q = mysqli_query($con, "SELECT * FROM history WHERE eid='$_GET[eid]' AND username='$_SESSION[username]'") or die('Error156');
                while ($row = mysqli_fetch_array($q)) {
                 ...
                 if($scorestatus=="false"){
                    $q = mysqli_query($con, "UPDATE history SET score_updated='true' WHERE username='$_SESSION[username]' AND eid='$_GET[eid]' ") or die('Error197');
                    $q = mysqli_query($con, "SELECT * FROM rank WHERE username='$username' AND eid='$_GET[eid]'") or die('Error161');
                    $rowcount = mysqli_num_rows($q);
                    if ($rowcount == 0) {
                        $q2 = mysqli_query($con, "INSERT INTO rank VALUES(NULL,'$username','$s',NOW(),'$_GET[eid]')") or die('Error165');
                    } else {
...
<center><h1 class="title" style="color:#660033">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
    ...
    <tr style="color:darkblue"><td style="vertical-align:middle">Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr></center>';
...
if (@$_GET['q'] == 2) {
    echo'<center><p class="intro">My History</p></center>';
